...
use crate::backend::prost::common_proto::{ClusterName, DBLocation, ServiceStatus};
...
pub struct ProxyServerArgs {
    ...
    #[clap(long, value_name = "CLUSTER WATCHER ADDR (Control Plane Grpc Address)")]
    pub cluster_watcher_addr: Option<String>,
